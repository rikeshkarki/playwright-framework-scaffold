...
- Name: ui/login.spec.ts >> Login >> invalid credentials show an error
- Location: src/tests/ui/login.spec.ts:26:7
...
- generic [ref=e1]:
  ...
  - generic [ref=e39]:
    - generic [ref=e41]:
      ...
      - generic [ref=e43]:
        - textbox "Email Address" [ref=e44]: nonexistent.user.zzz@example.com
        - textbox "Password" [ref=e45]: WrongPass123
