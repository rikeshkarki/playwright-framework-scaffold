...
Error: expect(Buffer).toMatchSnapshot(expected) failed
  ...
  88552 pixels (ratio 0.10 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - text: 
  - generic [ref=e818]:
    - button "Privacy and cookie settings" [ref=e819] [cursor=pointer]
    - generic [ref=e820]: "Managed by Google. Complies with IAB TCF. CMP ID: 300"
```
