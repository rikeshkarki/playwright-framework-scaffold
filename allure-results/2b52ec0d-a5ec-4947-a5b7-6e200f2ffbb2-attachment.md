...
- Location: src/tests/ui/accessibility.spec.ts:9:5
        ...
        "any": [
          {
            ...
            "relatedNodes": [
              {
                "html": "<body aria-hidden=\"false\" style=\"padding: 0px 0px 120px;\">",
                "target": [
                  "body"
                ]
              }
    ...
    - generic [ref=e69]:
      ...
      - insertion [ref=e91]:
        - generic [ref=e94]:
          ...
          - link "Software testing courses" [ref=e97] [cursor=pointer]
          - link "Test automation frameworks" [ref=e102] [cursor=pointer]
          - link "Compare Developer Tools" [ref=e107] [cursor=pointer]
          - link "Software testing books" [ref=e112] [cursor=pointer]
          - link "Automation practice platform" [ref=e117] [cursor=pointer]
          - link "Beginner testing guide" [ref=e122] [cursor=pointer]
          - link "Switch Broadband Providers" [ref=e127] [cursor=pointer]
          ...
          - generic [ref=e348]:
            - generic [ref=e349]:
              ...
              - paragraph [ref=e352]:
                ...
                - link "API testing services" [ref=e353] [cursor=pointer]
          ...
          - generic [ref=e390]:
            - generic [ref=e391]:
              ...
              - paragraph [ref=e394]:
                ...
                - link "Download Productivity Apps" [ref=e395] [cursor=pointer]
          ...
          - generic [ref=e470]:
            - generic [ref=e471]:
              ...
              - paragraph [ref=e474]:
                ...
                - link "T-Shirts" [ref=e475] [cursor=pointer]
          ...
          - generic [ref=e531]:
            - generic [ref=e532]:
              ...
              - paragraph [ref=e535]:
                ...
                - link "Browse Designer Clothes" [ref=e536] [cursor=pointer]
          ...
          - generic [ref=e826]:
            - generic [ref=e827]:
              ...
              - paragraph [ref=e830]:
                ...
                - link "T-Shirts" [ref=e831] [cursor=pointer]
...
```ts
  ...
  3  | 
  4  | // NOTE: this currently fails against the real automationexercise.com homepage
  5  | // (an icon-only "subscribe" button with no accessible name, low-contrast nav
  6  | // links, and unlabelled carousel arrows). That's expected here — it shows the
  7  | // test is genuinely checking, not silently passing like the original version
  8  | // (which called axe but never asserted on the results). See README.md.
  9  | test('Homepage has no critical or serious accessibility violations', async ({ page }) => {
  10 |   await page.goto('/');
  11 |   const results = await new AxeBuilder({ page }).analyze();
  12 | 
  13 |   const seriousOrWorse = results.violations.filter(
  14 |     (v) => v.impact === 'critical' || v.impact === 'serious'
  15 |   );
  16 | 
> 17 |   expect(seriousOrWorse, JSON.stringify(seriousOrWorse, null, 2)).toEqual([]);
     |                                                                   ^ Error: [
  18 | });
  19 | 
```